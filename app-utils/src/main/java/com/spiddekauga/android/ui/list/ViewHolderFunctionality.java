...
/**
 * Adapter functionality that implements the ability to to have a view holder
 */
public interface ViewHolderFunctionality<T> extends AdapterFunctionality<T> {
 ...
 * calls.
 * @param parent The ViewGroup into which the new View will be added after it is bound to an adapter
 * position.
...
/**
 * @return get the view for the view holder
 */
int getViewType();

/**
 * @return get view holder class type
 */
 ...
 * the position of the item changes in the data set unless the item itself is invalidated or the new
 ...
 * @param view The ViewHolder which should be updated to represent the contents of the item at the
 * given position in the data set.
 * @param position The position of the item within the adapter's data set.
 */
void onBindViewHolder(AdvancedAdapter<T, ?> adapter, RecyclerView.ViewHolder view, int position);
}
